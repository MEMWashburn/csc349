...
public class Tester {
    public static void main(String args[]) {
         ...
         System.out.println("Testing set1: " + set1Matches + " matches in 200 tests");
         System.out.println("Testing set2: " + set2Matches + " matches in 200 tests");
         System.out.println("Testing set3: " + set3Matches + " matches in 200 tests");
         System.out.println("Testing set4: " + set4Matches + " matches in 200 tests");
         System.out.println("Testing set5: " + set5Matches + " matches in 200 tests");
    }
